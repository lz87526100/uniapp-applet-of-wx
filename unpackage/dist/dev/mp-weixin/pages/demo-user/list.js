...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
      ...
      return common_vendor.e({
        ...
        d: common_vendor.f(data, (item, index, i1) => {
          return {
            ...
            d: "79786687-2-" + i0 + "-" + i1 + "," + ("79786687-1-" + i0)
          };
        }),
        e: common_vendor.p({
          showArrow: true,
        ...
        f: "79786687-1-" + i0 + ",79786687-0"
      } : {}, {
        c: data,
        g: "79786687-3-" + i0 + ",79786687-0",
        h: common_vendor.p({
    ...
    b: common_vendor.sr("udb", "79786687-0"),
    c: common_vendor.p({
      collection: $data.collectionList,
      field: "name,age,gender,avatar"
    }),
    d: common_vendor.sr("fab", "79786687-4"),
...
//# sourceMappingURL=../../../.sourcemap/mp-weixin/pages/demo-user/list.js.map
